...
def create_service_meta(container_factory, config):
    """ Returns a convenience method for creating service test instance
        `container_factory` is a Nameko's test fixture for creating service container
    """
...
def gateway_service(create_service_meta):
    """ Gateway service test instance with mocked `signals_rpc`"""
    return create_service_meta('signals_rpc')
